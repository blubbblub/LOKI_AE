...
location_t0 = Extension('location_t0', sources=['location_t0_py3_omp.c'],
                          include_dirs=[numpy.get_include()],
                          extra_compile_args=['-O3','-fopenmp'],
                          extra_link_args=['-lgomp'])
...
# run the setup
setup(ext_modules=[location,location_t0,ps_detection,ps1s2_detection,p_detection,tt_processing,C_STALTA, DET_STALTA])
